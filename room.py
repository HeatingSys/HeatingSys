...
class Room:
    def __init__(self, temp1,name):
        ...
        self.currentTime ='23:00' # should be a read from now() - for testing purposes leaving this alone rn
...
#manually change temp
    ...
    def changeTempDirectly(self,desiredTemp):
        self.thermomstat.turnOnHeater() # will call one of the temp functions here instead
